...
/*
	...
	Метод приймає два параметри:
		1 - повна назва файлу
			Якщо файл знаходиться в проекті, вказуєте лише його зазву, до прикладу "..\folder\fileName.txt"
			Якщо поза межами проекту, в іншій папці, тоді повний шлях, до прикладу "C:\Users\Ivan\Documents\fileName.txt"
...
//	ofstream fOut("new_file.txt", ios_base::app);
//
